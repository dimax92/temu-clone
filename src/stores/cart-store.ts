import { getOrCreateCart, syncCartWithUser, updateCart } from '@/actions/cart-actions';
    ...
    persist(
        (set, get) => ({
            ...
            addItem: async (item) => {
                ...
                const updatedCart = await updateCart(cartId, item.id, {
                    title: item.title,
                    price: item.price,
                    image: item.image,
            ...
            removeItem: async (id) => {
                ...
                const updatedCart = await updateCart(cartId, id, {
                    quantity: 0
                })
