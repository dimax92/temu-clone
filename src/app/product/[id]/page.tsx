        ...
        <div className='bg-gray-50'>
            ...
            <div className='container mx-auto py-8'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    ...
                    {
                        product.image && (
                            <div className='rounded-2xl bg-white p-4 overflow-hidden shadow-lg aspect-square'>
                        ...
                        <div className='flex flex-col gap-2 mt-4'>
                            ...
                            <div className='flex items-center gap-2 bg-red-50 p-2 rounded-lg'>
                                ...
                                <span className='text-red-600 font-medium text-sm'>
                                    Tou save {formatPrice(originalPrice - product.price)}!
                                </span>
                            </div>
                            <div className='flex items-center gap-2 text-xs text-gray-600'>
                                <span className='inline-block w-2 h-2 bg-green-500 rounded-full animate-pulse'></span>
                                <span className=''>{Math.floor(Math.random() * 50) + 20} people bought in the last hour</span>
                            </div>
                        </div>
